...
class Module extends DependenciesBlock {
	...
	getUsedName(moduleGraph, exportName) {
		...
		if (this.isProvided(moduleGraph, exportName)) {
	 ...
	 */
	isProvided(moduleGraph, exportName) {
		const providedExports = moduleGraph.getProvidedExports(this);
		if (Array.isArray(providedExports)) {
			return providedExports.includes(exportName);
		} else {
			return null;
		}
	}
